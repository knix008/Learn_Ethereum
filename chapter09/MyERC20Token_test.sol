...
contract MyERC20TokenTest {
    ...
    function beforeAll() public {
        ...
        myERC20TokenToTest = new MyERC20Token(
            "MyERC20Token",
            "MTK",
            acct0,
    ...
    function checkTotalSupply() public {
        ...
        Assert.equal(
            myERC20TokenToTest.totalSupply(),
    ...
    function checkBalanceOf() public {
        ...
        Assert.equal(
            myERC20TokenToTest.balanceOf(acct0),
            uint(100000000000000000000),
            "balanceOf number is wrong"
        );
    }
    ...
    function checkIsWhitelist() public {
        ...
        Assert.equal(
            myERC20TokenToTest.isWhitelist(acct0),
            true,
            "initial account is whitelisted"
        );
    }
    ...
    function checkValidateTransferRestricted() public {
        ...
        Assert.equal(
            myERC20TokenToTest.validateTransferRestricted(acct0),
            0,
            "initial account is not restricted"
        );
        Assert.equal(
            myERC20TokenToTest.validateTransferRestricted(acct1),
            1,
            "Second account is restricted before whileListed"
        );
        myERC20TokenToTest.addWhitelist(acct1);
        Assert.equal(
            myERC20TokenToTest.validateTransferRestricted(acct1),
            0,
            "Second account is not restricted"
        );
    }
}
