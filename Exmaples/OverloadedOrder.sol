...
contract OverloadedOrders {
    ...
    //function getOrder(address account) view public returns (string memory, string memory, uint) {
    //    return (orders[account].buyer, orders[account].product, orders[account].quantity);
    //}      
} 
