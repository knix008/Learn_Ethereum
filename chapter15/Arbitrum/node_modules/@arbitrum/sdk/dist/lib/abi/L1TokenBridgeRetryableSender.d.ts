...
export declare type RetryableParamsStruct = {
    inbox: string;
    target: string;
...
export declare type RetryableParamsStructOutput = [
    string,
    string,
    string,
    string,
...
export declare type L2TemplateAddressesStruct = {
...
export declare type L2TemplateAddressesStructOutput = [
    string,
    string,
    string,
    string,
