...
export declare type AllowedExecutorDestinationsUpdatedEvent = TypedEvent<[
    string,
    boolean
], {
    destination: string;
...
export declare type AllowedExecutorDestinationsUpdatedEventFilter = TypedEventFilter<AllowedExecutorDestinationsUpdatedEvent>;
export declare type ExecutorUpdatedEvent = TypedEvent<[
    string,
    boolean
], {
    executor: string;
...
export declare type ExecutorUpdatedEventFilter = TypedEventFilter<ExecutorUpdatedEvent>;
