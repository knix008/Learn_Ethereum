...
export declare type ERC20InboxRetryableTicketEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber,
...
export declare type ERC20InboxRetryableTicketEventFilter = TypedEventFilter<ERC20InboxRetryableTicketEvent>;
export declare type InboxRetryableTicketEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber,
...
export declare type InboxRetryableTicketEventFilter = TypedEventFilter<InboxRetryableTicketEvent>;
export declare type RefundAddressesEvent = TypedEvent<[
    string,
    string
], {
...
export declare type RefundAddressesEventFilter = TypedEventFilter<RefundAddressesEvent>;
