...
export declare type ExecutionContextStruct = {
    maxInboxMessagesRead: BigNumberish;
    bridge: string;
};
export declare type ExecutionContextStructOutput = [BigNumber, string] & {
    maxInboxMessagesRead: BigNumber;
    bridge: string;
};
export declare type ValueStruct = {
    valueType: BigNumberish;
    contents: BigNumberish;
};
export declare type ValueStructOutput = [number, BigNumber] & {
    valueType: number;
    contents: BigNumber;
};
export declare type ValueArrayStruct = {
    inner: ValueStruct[];
};
export declare type ValueArrayStructOutput = [ValueStructOutput[]] & {
    inner: ValueStructOutput[];
};
export declare type ValueStackStruct = {
    proved: ValueArrayStruct;
    remainingHash: BytesLike;
};
export declare type ValueStackStructOutput = [ValueArrayStructOutput, string] & {
    proved: ValueArrayStructOutput;
    remainingHash: string;
};
export declare type StackFrameStruct = {
    returnPc: ValueStruct;
    localsMerkleRoot: BytesLike;
    callerModule: BigNumberish;
    callerModuleInternals: BigNumberish;
};
export declare type StackFrameStructOutput = [
    ValueStructOutput,
    string,
    number,
    number
...
export declare type StackFrameWindowStruct = {
    proved: StackFrameStruct[];
    remainingHash: BytesLike;
};
export declare type StackFrameWindowStructOutput = [
...
export declare type MachineStruct = {
    status: BigNumberish;
...
export declare type MachineStructOutput = [
    number,
...
export declare type ModuleMemoryStruct = {
    size: BigNumberish;
    maxSize: BigNumberish;
    merkleRoot: BytesLike;
};
export declare type ModuleMemoryStructOutput = [BigNumber, BigNumber, string] & {
    size: BigNumber;
    maxSize: BigNumber;
    merkleRoot: string;
};
export declare type ModuleStruct = {
...
export declare type ModuleStructOutput = [
    string,
...
export declare type InstructionStruct = {
    opcode: BigNumberish;
    argumentData: BigNumberish;
};
export declare type InstructionStructOutput = [number, BigNumber] & {
    opcode: number;
