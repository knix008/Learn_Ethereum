...
export declare type TemplateUpdatedEvent = TypedEvent<[], {}>;
export declare type TemplateUpdatedEventFilter = TypedEventFilter<TemplateUpdatedEvent>;
export declare type WalletCreatedEvent = TypedEvent<[
    string,
    string,
    string,
    string
...
export declare type WalletCreatedEventFilter = TypedEventFilter<WalletCreatedEvent>;
