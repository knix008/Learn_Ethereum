...
export declare type ChallengeEndedEvent = TypedEvent<[
    BigNumber,
    number
], {
    challengeIndex: BigNumber;
...
export declare type ChallengeEndedEventFilter = TypedEventFilter<ChallengeEndedEvent>;
export declare type ExecutionChallengeBegunEvent = TypedEvent<[
    BigNumber,
    BigNumber
], {
    challengeIndex: BigNumber;
...
export declare type ExecutionChallengeBegunEventFilter = TypedEventFilter<ExecutionChallengeBegunEvent>;
