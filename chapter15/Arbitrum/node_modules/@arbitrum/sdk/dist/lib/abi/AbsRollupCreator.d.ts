...
export interface AbsRollupCreatorInterface extends utils.Interface {
    contractName: "AbsRollupCreator";
    functions: {
...
export interface AbsRollupCreator extends BaseContract {
    contractName: "AbsRollupCreator";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbsRollupCreatorInterface;
