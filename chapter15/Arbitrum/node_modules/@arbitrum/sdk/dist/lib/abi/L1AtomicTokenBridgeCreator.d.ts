...
export declare type L1DeploymentAddressesStruct = {
    router: string;
...
export declare type L1DeploymentAddressesStructOutput = [
    string,
    string,
    string,
    string,
...
export declare type L2DeploymentAddressesStruct = {
    router: string;
    standardGateway: string;
    customGateway: string;
    wethGateway: string;
...
export declare type L2DeploymentAddressesStructOutput = [
    string,
    string,
    string,
    string,
...
export declare type OrbitTokenBridgeCreatedEvent = TypedEvent<[
    string,
    string,
...
export declare type OrbitTokenBridgeCreatedEventFilter = TypedEventFilter<OrbitTokenBridgeCreatedEvent>;
export declare type OrbitTokenBridgeDeploymentSetEvent = TypedEvent<[
    string,
    L1DeploymentAddressesStructOutput,
    L2DeploymentAddressesStructOutput
], {
...
export declare type OrbitTokenBridgeDeploymentSetEventFilter = TypedEventFilter<OrbitTokenBridgeDeploymentSetEvent>;
export declare type OrbitTokenBridgeTemplatesUpdatedEvent = TypedEvent<[], {}>;
export declare type OrbitTokenBridgeTemplatesUpdatedEventFilter = TypedEventFilter<OrbitTokenBridgeTemplatesUpdatedEvent>;
