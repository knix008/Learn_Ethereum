...
export declare type DefaultGatewayUpdatedEvent = TypedEvent<[
    string
], {
    newDefaultGateway: string;
}>;
export declare type DefaultGatewayUpdatedEventFilter = TypedEventFilter<DefaultGatewayUpdatedEvent>;
export declare type GatewaySetEvent = TypedEvent<[
    string,
    string
], {
    l1Token: string;
...
export declare type GatewaySetEventFilter = TypedEventFilter<GatewaySetEvent>;
export declare type TransferRoutedEvent = TypedEvent<[
    string,
    string,
    string,
    string
...
export declare type TransferRoutedEventFilter = TypedEventFilter<TransferRoutedEvent>;
