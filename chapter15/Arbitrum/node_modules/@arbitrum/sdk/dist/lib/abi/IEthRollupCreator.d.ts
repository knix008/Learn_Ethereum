...
export interface IEthRollupCreatorInterface extends utils.Interface {
    contractName: "IEthRollupCreator";
    functions: {
        "createRollup((uint64,uint64,address,uint256,bytes32,address,address,uint256,string,uint64,(uint256,uint256,uint256,uint256)))": FunctionFragment;
        "setTemplates(address,address,address,address,address,address,address)": FunctionFragment;
    };
    encodeFunctionData(functionFragment: "createRollup", values: [ConfigStruct]): string;
...
export interface IEthRollupCreator extends BaseContract {
    contractName: "IEthRollupCreator";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IEthRollupCreatorInterface;
    ...
    functions: {
        createRollup(config: ConfigStruct, overrides?: Overrides & {
    ...
    callStatic: {
        createRollup(config: ConfigStruct, overrides?: CallOverrides): Promise<string>;
