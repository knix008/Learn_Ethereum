...
export declare type WithdrawTriggeredEvent = TypedEvent<[], {}>;
export declare type WithdrawTriggeredEventFilter = TypedEventFilter<WithdrawTriggeredEvent>;
export declare type ZombieTriggeredEvent = TypedEvent<[], {}>;
export declare type ZombieTriggeredEventFilter = TypedEventFilter<ZombieTriggeredEvent>;
